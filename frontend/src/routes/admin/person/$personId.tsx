            ...
            <>
              ...
              <div>
                <h1 className="text-3xl font-bold">
                  {person.first_name || person.username || person.email || 'Unnamed Person'} 
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Badge>{person.clearance_level || 'NONE'}</Badge>
          </div>
        </div>
      </CardContent>
    </Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Vendor Relations for {personName}</CardTitle>
